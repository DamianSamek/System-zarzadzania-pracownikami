...
INSERT INTO `user` (`id`, `first_name`, `second_name`, `email`, `password`, `enabled`, `id_role`) VALUES ('2', 'Jan', 'Nowak', 'jannowak@firma.pl', '$2a$04$WAOrZR0ak7FrOB.A6EZ7aukL8G9sh7FiUKZ6X2kMggTS.LP.4Nibe', b'1', '2');
INSERT INTO `user` (`id`, `first_name`, `second_name`, `email`, `password`, `enabled`, `id_role`) VALUES ('3', 'Marcin', 'Deresz', 'marcinderesz@firma.pl', '$2a$04$WAOrZR0ak7FrOB.A6EZ7aukL8G9sh7FiUKZ6X2kMggTS.LP.4Nibe', b'1', '2');
INSERT INTO `user` (`id`, `first_name`, `second_name`, `email`, `password`, `enabled`, `id_role`) VALUES ('4', 'Katarzyna', 'Kot', 'katarzynakot@firma.pl', '$2a$04$WAOrZR0ak7FrOB.A6EZ7aukL8G9sh7FiUKZ6X2kMggTS.LP.4Nibe', b'1', '2');
INSERT INTO `user` (`id`, `first_name`, `second_name`, `email`, `password`, `enabled`, `id_role`) VALUES ('5', 'Anna', 'Potoczna', 'annapotoczna@firma.pl', '$2a$04$WAOrZR0ak7FrOB.A6EZ7aukL8G9sh7FiUKZ6X2kMggTS.LP.4Nibe', b'1', '2');
INSERT INTO `user` (`id`, `first_name`, `second_name`, `email`, `password`, `enabled`, `id_role`) VALUES ('6', 'Aleksander', 'Wolski', 'aleksanderwolski@firma.pl', '$2a$04$WAOrZR0ak7FrOB.A6EZ7aukL8G9sh7FiUKZ6X2kMggTS.LP.4Nibe', b'1', '2');
